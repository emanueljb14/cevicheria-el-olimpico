    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <h4 class="fw-bold mb-0 text-dark" style="font-family: 'Playfair Display', Georgia, serif;">Editar Cliente</h4>
            </div>
        </div>
        ...
        <form action="{{ route('clientes.update', $cliente->id) }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select name="tipo_documento" id="tipo_documento" class="form-select border-0 text-dark p-3 @error('tipo_documento') is-invalid @enderror" style="background-color: #f8f9fa;" required>
                            ...
                            <option value="CE" {{ old('tipo_documento', $cliente->tipo_documento) == 'CE' ? 'selected' : '' }}>Carné de Extranjería</option>
                        </select>
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="numero_documento" id="numero_documento" class="form-control border-0 text-dark p-3 @error('numero_documento') is-invalid @enderror" style="background-color: #f8f9fa;" value="{{ old('numero_documento', $cliente->numero_documento) }}" placeholder="Ej. 72839102" required>
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control border-0 text-dark p-3 @error('nombre') is-invalid @enderror" style="background-color: #f8f9fa;" value="{{ old('nombre', $cliente->nombre) }}" placeholder="Ej. Juan Pérez u Holas S.A.C." required>
                        @error('nombre')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="telefono" id="telefono" class="form-control border-0 text-dark p-3" style="background-color: #f8f9fa;" value="{{ old('telefono', $cliente->telefono) }}" placeholder="987654321">
                    </div>

                    <div class="col-md-6">
                        <label for="email" class="form-label text-uppercase text-secondary fw-bold fs-7">Correo Electrónico</label>
                        <input type="email" name="email" id="email" class="form-control border-0 text-dark p-3" style="background-color: #f8f9fa;" value="{{ old('email', $cliente->email) }}" placeholder="cliente@ejemplo.com">
                    </div>

                    <div class="col-12 mt-3">
                        <label for="direccion" class="form-label text-uppercase text-secondary fw-bold fs-7">Dirección de Entrega</label>
                        <input type="text" name="direccion" id="direccion" class="form-control border-0 text-dark p-3" style="background-color: #f8f9fa;" value="{{ old('direccion', $cliente->direccion) }}" placeholder="Av. Los Olivos 123">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-end gap-3 pt-4 mt-4 border-top" style="border-color: #f0f0f0 !important;">
                ...
                <button type="submit" class="btn rounded-pill px-4 py-2-5 fw-bold shadow-sm text-dark" style="background-color: #f2a922; border: none;">
                    <i class="bi bi-arrow-repeat me-1"></i> Actualizar Cliente
                </button>
            </div>
        </form>
    </div>
