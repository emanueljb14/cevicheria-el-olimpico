    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <h4 class="fw-bold mb-0 text-dark" style="font-family: 'Playfair Display', Georgia, serif;">Editar Platillo</h4>
            </div>
        </div>
        ...
        <form action="{{ route('productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-7">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control border-0 text-dark p-3 @error('nombre') is-invalid @enderror" style="background-color: #f8f9fa;" value="{{ old('nombre', $producto->nombre) }}" placeholder="Ej. Ceviche Carretillero, Jalea Mixta..." required autofocus>
                    @error('nombre')
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" min="0" name="precio" id="precio" class="form-control border-0 text-dark p-3 @error('precio') is-invalid @enderror" style="background-color: #f8f9fa;" value="{{ old('precio', $producto->precio) }}" placeholder="0.00" required>
                    </div>
                    @error('precio')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="stock" id="stock" class="form-control border-0 text-dark p-3 @error('stock') is-invalid @enderror" style="background-color: #f8f9fa;" value="{{ old('stock', $producto->stock) }}" min="0">
                    @error('stock')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="descripcion" id="descripcion" rows="3" class="form-control border-0 text-dark p-3" style="background-color: #f8f9fa;" placeholder="Ej. Pescado fresco del día, limón piurano, camote glaseado y choclo desgranado...">{{ old('descripcion', $producto->descripcion) }}</textarea>
                </div>
                ...
                <div class="col-12">
                    <div class="p-3 rounded-3 d-flex align-items-center justify-content-between" style="background-color: #f8f9fa;">
                        ...
                        <div class="form-check form-switch fs-4 mb-0">
                            <input class="form-check-input" type="checkbox" role="switch" id="estado" name="estado" value="1" {{ old('estado', $producto->estado) ? 'checked' : '' }}>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-end gap-3 pt-4 mt-4 border-top" style="border-color: #f0f0f0 !important;">
                ...
                <button type="submit" class="btn rounded-pill px-4 py-2-5 fw-bold shadow-sm text-dark" style="background-color: #f2a922; border: none;">
                    <i class="bi bi-arrow-repeat me-1"></i> Actualizar Platillo
                </button>
            </div>
        </form>
    </div>
