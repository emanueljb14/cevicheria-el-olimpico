    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <h4 class="fw-bold mb-0 text-dark" style="font-family: 'Playfair Display', Georgia, serif;">Editar Categoría</h4>
            </div>
        </div>
        ...
        <form action="{{ route('categorias.update', $categoria->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="nombre" id="nombre" 
                           ...
                           value="{{ old('nombre', $categoria->nombre) }}" placeholder="Ej. Ceviches, Jaleas, Bebidas" required autofocus>
                </div>
                @error('nombre')
            ...
            <div class="mb-4">
                ...
                <textarea name="descripcion" id="descripcion" rows="3" 
                          ...
                          style="background-color: #f8f9fa;" 
                          placeholder="Escribe una breve reseña del tipo de platillos...">{{ old('descripcion', $categoria->descripcion) }}</textarea>
                @error('descripcion')
                    <div class="text-danger small mt-2 d-flex align-items-center"><i class="bi bi-exclamation-circle me-1"></i> {{ $message }}</div>
                @enderror
            </div>
