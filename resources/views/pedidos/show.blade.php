    ...
    <div class="card-panel">
        <form action="{{ route('detalle_pedidos.store') }}" method="POST" class="form-agregar-item">
            ...
            <div class="form-group">
                <label class="info-label" style="margin-bottom: 0.35rem;">Producto</label>
                <select name="producto_id" required class="select-estado" style="width: 100%; height: 42px;">
            ...
            <div class="form-group">
                <label class="info-label" style="margin-bottom: 0.35rem;">Cantidad</label>
                <input type="number" name="cantidad" value="1" min="1" required class="input-cantidad" style="width: 100%; height: 42px;">
            </div>
    ...
    <div class="table-container">
        <table class="pedidos-table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" style="text-align: center; color: var(--olimpico-muted); padding: 2rem;">
            ...
            <tfoot>
                <tr>
                    <td colspan="3" style="text-align: right; font-weight: 700; padding: 1rem;">TOTAL DEL PEDIDO:</td>
