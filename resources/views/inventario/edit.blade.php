...
<div class="inventario-page">
    <header class="inventario-header">
        <div>
            ...
            <h1>Editar Insumo: {{ $inventario->nombre_insumo }}</h1>
        </div>
        ...
        <form action="{{ route('inventario.update', $inventario->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-box">
                    ...
                    <input id="nombre" type="text" name="nombre" class="form-control" value="{{ old('nombre', $inventario->nombre_insumo) }}" required>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-box">
                    ...
                    <input id="unidad_medida" type="text" name="unidad_medida" class="form-control" value="{{ old('unidad_medida', $inventario->unidad_medida) }}" required>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-box">
                    ...
                    <input id="stock_actual" type="number" step="0.01" name="stock_actual" class="form-control" value="{{ old('stock_actual', $inventario->stock) }}" min="0" required>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-box">
                    ...
                    <input id="stock_minimo" type="number" step="0.01" name="stock_minimo" class="form-control" value="{{ old('stock_minimo', $inventario->stock_minimo) }}" min="0" required>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-box">
                    ...
                    <select id="producto_id" name="producto_id" class="form-control" style="padding-left:42px;">
            ...
            <button type="submit" class="submit-button">
                <i class="fa-solid fa-rotate"></i> Actualizar Insumo
            </button>
        </form>
    </div>
</div>
